...
function App() {
  ...
  return (
    <>
        <div style={{margin:'62px 18% 24px 18%'}}>
            <h2>전시회 상세페이지</h2>

            <div style={{display: 'inline-block', marginRight:'32px', width:541, height:363}}>
                <div style={{width:541, height:363}}><img style={{width: '100%', height: '100%', paddingRight:'32px'}} src="https://via.placeholder.com/541x363" /></div>
            </div>
            ...
            <div style={{marginTop:'32px', marginBottom:'46px'}}>
